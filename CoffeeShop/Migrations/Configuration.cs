    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CoffeeShop.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(CoffeeShop.Models.ApplicationDbContext context)
        {
            ...
            var SoyMilk = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/Soy_milk#/media/File:Soy_milk_(2).jpg",
                Price = 10,
                QuantityInStock = 70
            };
            var AlmondMilk = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/Almond_milk#/media/File:Home-made_almond_milk,_November_2012.jpg",
                Price = 15,
                QuantityInStock = 70
            };
            var WhiteSugar = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/White_sugar#/media/File:A_Bowl_of_Sugar_2.jpg",
                Price = 5,
                QuantityInStock = 100
            };
            ...
            var Chocolate = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/Chocolate#/media/File:Chocolate_(blue_background).jpg",
                Price = 25,
                QuantityInStock = 80
            };
            var Caramel = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/Caramel#/media/File:Caramel-2.jpg",
                Price = 20,
                QuantityInStock = 80
            };
            var CoconutOil = new IngredientModel
            {
                ...
                ImgUrl = "https://en.wikipedia.org/wiki/Coconut_oil#/media/File:Coconut_and_oil.jpg",
                Price = 25,
                QuantityInStock = 50
            };
            ...
            CoffeeModel Espresso = new CoffeeModel
            {
                ...
                //            context.Ingredients.Find(ArabicaBean.IngredientId)
                //    },
            ...
            //    Ingredients = new List<IngredientModel> {
            //                context.Ingredients.Find(ArabicaBean.IngredientId),
            //                context.Ingredients.Find(Milk.IngredientId),
            //        },
            ...
            //    Coffee = context.Coffee.Find(Espresso.CoffeeId),
            //    CoffeeId = Espresso.CoffeeId,
            //    Ingredient = context.Ingredients.Find(ArabicaBean.IngredientId),
            ...
            //{
            //    IngredientInCoffeeId = Guid.NewGuid(),
            //    Coffee = context.Coffee.Find(Machiatto.CoffeeId),
            ...
            //    Coffee = context.Coffee.Find(Machiatto.CoffeeId),
            //    CoffeeId = Machiatto.CoffeeId,
            //    Ingredient = context.Ingredients.Find(Milk.IngredientId),
            ...
            //{
            //    IngredientInCoffeeId = Guid.NewGuid(),
            //    Coffee = context.Coffee.Find(Cappuccino.CoffeeId),
